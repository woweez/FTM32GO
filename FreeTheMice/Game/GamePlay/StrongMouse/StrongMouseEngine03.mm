...
-(void)hotSmokingFunc{
    ...
    if(![FTMUtil sharedInstance].isInvincibilityOn &&  heroSprite.position.x-iValue>515 && heroSprite.position.x-iValue<= 600&& heroSprite.position.y>380&&heroSprite.position.y<=530&&!heroTrappedChe&&!waterStopChe){
