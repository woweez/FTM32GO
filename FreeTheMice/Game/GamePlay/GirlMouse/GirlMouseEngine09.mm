...
//        [self addChild:catSpriteSheet z:1];
        ...
        [self addChild:visibleSprite[0] z:8];
        ...
        [self addChild:visibleSprite[3] z:8];
...
//        [self addChild:gateSprite z:0];
        ...
        crackedSprite.position=ccp(626,513);
