...
//        [self addChild:catSpriteSheet z:1];
        ...
        [self addChild:woodVisibleSprite[0] z:9];
        ...
        [self addChild:woodVisibleSprite[1] z:9];
        ...
        [self addChild:woodVisibleSprite[2] z:9];
        ...
        [self addChild:appleWoodAtlas[0] z:9];
        ...
        [self addChild:appleWoodAtlas[1] z:9];
        
        CCSprite *crackedSprite=[CCSprite spriteWithFile:@"cracked.png"];
        crackedSprite.position=ccp(228,400);
        [self addChild:crackedSprite z:9];
        
        crackedSprite=[CCSprite spriteWithFile:@"cracked.png"];
        crackedSprite.position=ccp(228,255);
        [self addChild:crackedSprite z:9];
        
        crackedSprite=[CCSprite spriteWithFile:@"cracked.png"];
        crackedSprite.position=ccp(224,490);
        [self addChild:crackedSprite z:9];
        
        crackedSprite=[CCSprite spriteWithFile:@"cracked.png"];
        crackedSprite.position=ccp(498,355);
        crackedSprite.flipX=1;
        crackedSprite.flipY=1;
        [self addChild:crackedSprite z:9];
        
        crackedSprite=[CCSprite spriteWithFile:@"cracked.png"];
        crackedSprite.position=ccp(498,303);
        crackedSprite.flipX=1;
        [self addChild:crackedSprite z:9];
